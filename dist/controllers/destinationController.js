...
export const addDestination = async (req, res) => {
    try {
        ...
        const { name, country, city, shortDescription, description, price, durationDays, category, bestSeason, rating, coverImage, galleryImages, } = req.body;
 ...
 */
export const getDestinationStats = async (_req, res) => {
    try {
